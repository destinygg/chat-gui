const USERS = {
  ...
  plain1: { nick: 'Normie1', features: [], roles: ['user'] },
  plain2: { nick: 'Normie2', features: [], roles: ['user'] },
  plain3: { nick: 'Chatter3', features: [], roles: ['user'] },
  plain4: { nick: 'Lurker4', features: [], roles: ['user'] },
  plain5: { nick: 'NewFrog5', features: [], roles: ['user'] },
};
